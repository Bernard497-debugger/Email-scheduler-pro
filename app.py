...
Using APScheduler (MORE RELIABLE)
"""
...
def check_and_send_emails():
    ...
    print(f"[{datetime.now().strftime('%H:%M:%S')}] APScheduler: Checking for due emails...")
...
def schedule_email():
    ...
    try:
        ...
        flash(f'⏰ APScheduler will send it (checks every 30 seconds)', 'info')
    except ValueError:
...
def scheduler_status():
    ...
    <body style="font-family: Arial; padding: 20px;">
        ...
        <p><strong>APScheduler:</strong> ✅ Running (checks every 30 seconds)</p>
...
<div class="hero"><h1>⚡ Schedule Emails Automatically</h1><p>APScheduler running - checks every 30 seconds</p>{% if not session.user_id %}<a href="/register" class="btn">Get Started Free</a>{% endif %}</div>
...
if __name__ == '__main__':
    ...
    print("=" * 50)
    print("🚀 Email Scheduler Pro - WITH APSCHEDULER")
